...
\begin{column}{0.5\textwidth}
  ...
  This rules out:
   {\small \pause PDFs, \pause jpg's, \pause, Microsoft Word, \pause any Powerpoint,\pause Excel (\code{xlsx}), \pause Google Docs\pause,  \code{.sav}, \code{.por}, \code{.dta}, \code{.Rds}, \code{RData}...}
\pause 
